	...
	╚██╗ ██╔╝██║╚██╔╝██║██║      ╚═══██╗██║      ╚═══██╗
	 ╚████╔╝ ██║ ╚═╝ ██║███████╗██████╔╝███████╗██████╔╝
	  ╚═══╝  ╚═╝     ╚═╝╚══════╝╚═════╝ ╚══════╝╚═════╝ 
		...
		\033[92m ~{\033[0m Github \033[92m: \033[0mhttps://github.com/trhacknon\033[92m}~                                          
		''' + endc)
...
def Send_Commands(Connection) :
	...
	while True :
		...
		if Commands == "help" :
			...
			print (green + "[^] Author      : " + endc + "trhacknon" + endc)
			print (green + "[^] Github      : " + endc + "https://github.com/trhacknon" + endc)
			print (green + "[^] Twitter     : " + endc + "https://twitter.com/" + endc)
			print (green + "[^] Facebook    : " + endc + "https://www.facebook.com/" + endc)
			print (green + "[^] Instagram    : " + endc + "https://www.instagram.com//" + endc)
			print("")
